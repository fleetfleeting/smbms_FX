...
public class BillDaoImpl implements BillDao {
    ...
    public int add(Connection connection, Bill bill) throws Exception {
        ...
        int flag=0;
        if(connection!=null){
            String sql="insert into smbms_bill (billCode,productName,productDesc, productUnit,productCount,totalPrice,isPayment,providerId,createdBy,creationDate) value(?,?,?,?,?,?,?,?,?,?)";
    ...
    public List<Bill> getBillList(Connection connection, Bill bill) throws Exception {
        ...
        if(connection!=null){
            ...
            System.out.println("sql.tosting:"+sql.toString());
    ...
    public void test(){
        /*try {
            int i = getBillCountByProviderId(BaseDao.getConnection(), "BJ_GYS001");
